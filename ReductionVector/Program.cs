...
namespace ReductionVector
{
    internal static class Program
    {
        ...
        {
            const string resourceName = "ReductionVector.reduction.cl";
            ...
            using (var mem2 = new PinnedArrayOfStruct<float>(context, workGroupResults, MemMode.WriteOnly))
            {
                ...
                errorCode = Cl.SetKernelArg<float>(kernel, 1, localWorkSize* numValuesPerWorkItem);
